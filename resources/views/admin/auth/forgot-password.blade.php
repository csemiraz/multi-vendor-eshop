				...
				<div class="card-body">
					<div class="p-4 rounded  border">
						...
						<div class="d-grid gap-2">
							<button type="submit" class="btn btn-primary btn-lg">Send</button> <a href="{{ route('admin.login') }}" class="btn btn-light btn-lg"><i class='bx bx-arrow-back me-1'></i>Back to Login</a>
						</div>
                    </form>
					</div>
				</div>
